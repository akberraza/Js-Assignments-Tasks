...
function add(){
  if(itemBox.value == "" || priceBox.value == ""){
    ...
    var currentText = totalBox.innerHTML;
    var currentTotal = parseFloat(currentText.replace("Total : ","") || 0);
    var newPrice = parseFloat(priceBox.value) || 0;
...
/*var age = 2003;
document.writeln("My Birth year is " + age)*/

/*var  item1price = 500;
var  item2price = 700;
var add = item1price + item2price ;
var total = add * 2
console.log(total);*/

/*var city = "Karachi";
var messege = "Welcome to ";
var result = messege + city;
alert(result)*/

/*var user = prompt("Enter Your Name").toUpperCase();
alert(user);*/
...
/*function Uplode(){
  var getInpt = document.querySelector("#inp");
  var getImg = document.querySelector("#img");
  getImg.src = getInpt.value;
}*/

/*function uplode(){
    var getInpt = document.querySelector("#inp");
    var imageToURL = URL.createObjectURL(getInpt.files[0]);
    document.querySelector("#image").src = imageToURL 
}*/

/*function update(){
  var getInp = document.querySelector("#inp");
  var getImg = document.querySelector("#img");
  getImg.src = getInp.value;
}*/
...
/*function uploade(){
  var getInp = document.querySelector("#inp");
  var imgToUrl = URL.createObjectURL(getInp.files[0]);
  document.querySelector("#img").src = imgToUrl;
}*/
...
/*function uplBtn(){
  var getField = document.querySelector("#field");
  var convert = URL.createObjectURL(getField.files[0]);
  document.querySelector("#imgSce").src = convert;
}*/
...
function login(){
   ...
   if(matchedUser.length > 0){
    localStorage.setItem("loggedInp",JSON.stringify(matchedUser[0]));
...
function logout(){
  localStorage.removeItem("loggedInp");
  window.location.href = "signup.html";
}

function addPost(){
  var getImage = document.querySelector("#postImage").value;
  var getCaption = document.querySelector("#postCaption").value;
  var getPrice = document.querySelector("#postPrice").value;

  if(getImage === "" || getCaption === "" || getPrice === ""){
    alert("Please fill all post fields!");
    return;
  }

  var currentUser = JSON.parse(localStorage.getItem("loggedInp"));
  var newPost = {
      image: getImage,
      caption: getCaption,
      price: getPrice,
...
function displayPosts(){
  ...
  for(var i = 0; i < posts.length; i++){
    if(posts[i].email === currentUser.email){
      ...
      <p calss="card-text">price Rs: ${posts[i].price}</p>
...
window.onload = function(){
  ...
  if(path.includes("dashboard.html")){
    var user = JSON.parse(localStorage.getItem("loggedInp"));
    if(!user){
      window.location.href = "login.html";
    }else{
      displayPosts();
...
function login(){
  ...
  if(matchedUser.length > 0){
    ...
    alert("Email or Password is incorreect!")
  }
...
/*function addPost(){
  ...
  var allPosts = JSON.parse(localStorage.getItem("posts" || "[]"));
  allPosts.push(newPost);
  localStorage.setItem("posts".JSON.setItem(allPosts));
  ...
  var currentUser = JSON.parse(localStorage.getItem("loggedInUser"));
   ...
   for(var i = 0; i < posts.length; i++){
    if(posts[i].email === currentUser.email){
      ...
      <button class='btn btn-outline-succcess btn-sm'>Share</button>
     </div>
      `
